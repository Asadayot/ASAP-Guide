...
cp_file "$src_dir/patches/sys-patch/out/atmosphere/contents/420000000000000B/flags/boot2.flag" "$dist_dir/ASAP/atmosphere/contents/010B6ECF3B30D000/02"
cp_file "$src_dir/patches/sys-patch/out/atmosphere/contents/420000000000000B/exefs.nsp" "$dist_dir/ASAP/atmosphere/contents/010B6ECF3B30D000/02"
cp_file "$src_dir/ASAP-Updater/version" "$dist_dir/ASAP/atmosphere/contents/010B6ECF3B30D000/03"
